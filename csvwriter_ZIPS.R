...
write.csv(pitcher_projections, file = "pitcher_projections_ZIPS.csv")
write.csv(hitter_projections, file = "hitter_projections_ZIPS.csv")
...
write.csv(hitterpitcher, "bestremaining_ZIPS.csv")


#write out draft errors to csv
write.csv(drafterrors, "drafterrors_ZIPS.csv")
...
write.csv(standings.output, file="standings_ZIPS.csv")
